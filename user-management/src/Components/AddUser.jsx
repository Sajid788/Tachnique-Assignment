    ...
    <>
      ...
      <div className='add-user'>
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" name="firstName" placeholder='Enter firstName' value={formData.firstName} onChange={handleInputChange} />
          <input type="text" name="lastName" placeholder='Enter lastName' value={formData.lastName} onChange={handleInputChange} />
